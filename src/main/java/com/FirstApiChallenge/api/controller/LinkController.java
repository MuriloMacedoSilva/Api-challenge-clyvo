...
public class LinkController {
    ...
    @GetMapping("/veterinarian/{crmvNumber}/tutor/{tutorCpf}/animals")
    public ResponseEntity<Set<Animal>> getAnimalsForLinkedVet(
            @PathVariable String crmvNumber,
            @PathVariable String tutorCpf) {
        Set<Animal> animals = linkService.getTutorAnimalsIfLinked(crmvNumber, tutorCpf);
